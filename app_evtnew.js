...
v.addEventListener('click',()=>{
      ...
      document.querySelector('#ftp').setAttribute('placeholder',"Getting data...");
       ...
       var x = 0;
        setTimeout(()=>{
            form.elements.ftp.value =30+ Math.floor(Math.random() * 100)/10;
        }, 5000);  
        document.querySelector('#ftp').style.backgroundColor = '#c1c4c7';
...
w.addEventListener('click',()=>{
      ...
      document.querySelector('#eps').setAttribute('placeholder',"Getting data...");
       ...
       setTimeout(()=>{
                form.elements.eps.value = 1+g;
        }, 5000);
        document.querySelector('#eps').style.backgroundColor = '#c1c4c7';
